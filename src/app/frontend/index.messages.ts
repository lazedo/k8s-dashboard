...
export const BREADCRUMBS: IBreadcrumbMessage = {
  ...
  [IBreadcrumbMessageKey.AccessControl]: $localize`Access Control`,
  ...
  [IBreadcrumbMessageKey.VerticalPodAutoscalers]: $localize`Vertical Pod Autoscalers`,
  [IBreadcrumbMessageKey.ScaledObjects]: $localize`Scaled Objects`,
  [IBreadcrumbMessageKey.ScaledJobs]: $localize`Scaled Jobs`,
  [IBreadcrumbMessageKey.MachineDeployments]: $localize`Machine Deployments`,
  [IBreadcrumbMessageKey.MachineSets]: $localize`Machine Sets`,
  [IBreadcrumbMessageKey.Machines]: $localize`Machines`,
  [IBreadcrumbMessageKey.ClusterAPI]: $localize`Cluster API`,
  [IBreadcrumbMessageKey.NodePools]: $localize`Node Pools`,
  [IBreadcrumbMessageKey.NodeClaims]: $localize`Node Claims`,
  [IBreadcrumbMessageKey.ScalingAndAvailability]: $localize`Scaling & Availability`,
