...
export class GroupedResourceList {
  // Own copy: the shared const must never be mutated across page instances.
  ...
  private updateResourcesRatio_(identifier: ListIdentifier, list: ResourceList) {
    switch (identifier) {
      case ListIdentifier.cronJob: {
        ...
        this.resourcesRatio = {...this.resourcesRatio, cronJobRatio: Helper.getResourceRatio(
          cronJobs.status,
      ...
      case ListIdentifier.daemonSet: {
        ...
        this.resourcesRatio = {...this.resourcesRatio, daemonSetRatio: Helper.getResourceRatio(daemonSets.status, daemonSets.listMeta.totalItems)};
        break;
      }
      case ListIdentifier.deployment: {
        const deployments = list as DeploymentList;
        this.resourcesRatio = {...this.resourcesRatio, deploymentRatio: Helper.getResourceRatio(
          deployments.status,
      ...
      case ListIdentifier.job: {
        ...
        this.resourcesRatio = {...this.resourcesRatio, jobRatio: Helper.getResourceRatio(
          jobs.status,
      ...
      case ListIdentifier.pod: {
        ...
        this.resourcesRatio = {...this.resourcesRatio, podRatio: Helper.getResourceRatio(
          pods.status,
      ...
      case ListIdentifier.replicaSet: {
        ...
        this.resourcesRatio = {...this.resourcesRatio, replicaSetRatio: Helper.getResourceRatio(
          replicaSets.status,
      ...
      case ListIdentifier.replicationController: {
        ...
        this.resourcesRatio = {...this.resourcesRatio, replicationControllerRatio: Helper.getResourceRatio(
      ...
      case ListIdentifier.statefulSet: {
        ...
        this.resourcesRatio = {...this.resourcesRatio, statefulSetRatio: Helper.getResourceRatio(
          statefulSets.status,
