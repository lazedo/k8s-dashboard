...
export enum ListIdentifier {
  ...
  verticalPodAutoscaler = 'verticalPodAutoscalerList',
  scaledObject = 'scaledObjectList',
  scaledJob = 'scaledJobList',
  machineDeployment = 'machineDeploymentList',
  machineSet = 'machineSetList',
  machine = 'machineList',
  nodePool = 'nodePoolList',
  nodeClaim = 'nodeClaimList',
...
export enum ListGroupIdentifier {
  ...
  accessControl = 'accessControlGroup',
  clusterApi = 'clusterApiGroup',
  none = 'none',
}
